...
import { Users, Settings, Shield, Activity, Menu, Rss, Badge } from 'lucide-react';
...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { href: '/dashboard/blog', icon: Rss, label: 'Blogs' },
    { href: '/dashboard/role', icon: Badge, label: 'Roles' },
